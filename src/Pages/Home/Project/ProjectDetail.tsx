      ...
      <section className="pd-comparison">
        <div className="pd-side pre-build">
          ...
          <div className="pd-img-wrapper">
            <img
              src={project.oldImage || undefined}
              alt="Original Vehicle Condition"
            />
          </div>
        </div>
        ...
        <div className="pd-side post-build">
          ...
          <div className="pd-img-wrapper">
            <img
              ...
              alt="Modified Performance Result"
            />
          </div>
        </div>
      </section>
        ...
        <div className="pd-desc-grid">
          ...
          <div className="pd-specs-sidebar">
            ...
            <ul className="pd-spec-list">
              ...
              <li>
                <span>LOCATION:</span> CALICUT LAB
              </li>
              <li>
                <span>ENGINEERING:</span> STAGE 3
              </li>
              <li>
                <span>STATUS:</span> 100% COMPLETED
              </li>
            </ul>
          </div>
        </div>
