...
const Navbar: React.FC = () => {
  ...
  const handleScrollTo = (
    ...
    if (elem) {
      // If we're on the homepage and the element exists, scroll to it

      elem.scrollIntoView({ behavior: "smooth" });

      setIsMenuOpen(false); // Close mobile menu if open
    } else {
      // If we're not on the homepage or element doesn't exist, navigate to homepage with hash
  ...
  // Handle logo click - navigate to homepage top
